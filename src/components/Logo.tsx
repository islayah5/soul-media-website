...
export const Logo: React.FC<LogoProps> = ({ className = '', width = 180, height = 78 }) => {
  return (
    ...
    >
      <defs>
        {/* Soft Rose Pink Gradient (Official Primary Logo) */}
        <linearGradient id="mainGradientSoftRose" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFDAE0" stopOpacity={1} />
          <stop offset="50%" stopColor="#FFDAE0" stopOpacity={1} />
          <stop offset="100%" stopColor="#EF9DA3" stopOpacity={1} />
        </linearGradient>
